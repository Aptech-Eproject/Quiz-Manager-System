        ...
        >
            ...
            <div className="relative min-h-48">
                ...
                <img
                    src={thumbnailUrl}
                    alt={quiz.title}
                    className="w-full h-50 object-cover group-hover:scale-110 transition duration-300"
                />

                {/* Annotation Quiz */}
                <div className="absolute top-4 right-4 bg-white px-3 py-1 rounded-full text-sm font-medium">
                    {quiz.level ? quiz.level.charAt(0).toUpperCase() + quiz.level.slice(1) : 'N/A'}
                </div>
            </div>
