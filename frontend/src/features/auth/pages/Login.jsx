...
export default function Login() {
    ...
    useEffect(() => {
        toast.info('Login page is under construction!');
    }, [])
        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 flex items-center justify-center px-4">
            <div className="w-full max-w-md px-12">
                ...
                <button
                    ...
                    className="w-full bg-white hover:bg-gray-100 text-gray-700 font-medium py-3 rounded-lg transition duration-200 border-2 border-gray-200 flex items-center justify-center gap-3 cursor-pointer"
                >
